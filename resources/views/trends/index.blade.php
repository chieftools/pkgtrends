...
@section('content')
    ...
    @if(isset($query))
        <input type="hidden" id="package-options" data-value='{!! json_encode_html($query->getData()->pluck('info')) !!}'>
        <input type="hidden" id="package-items" data-value='{!! json_encode_html($query->getData()->pluck('info.id')) !!}'>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <input type="hidden" id="chart-labels" data-value='{!! json_encode_html($query->getGraphLabels()->all()) !!}'>
                <input type="hidden" id="chart-datasets" data-value='{!! json_encode_html($query->getData()->map(function ($dependency) use (&$colors) {
                        return [
